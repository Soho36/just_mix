...
# dict = {")": "(", "]": "["}
# string = "v lesu (rodils elcuha0v) [lesu] ona rosla"
...
#             stackdict.append(s)
#         elif s in dict.keys():
#             if len(stackdict)>0 and stackdict[-1] == dict[s]:
#                 stackdict.pop()
#             else:
#                 return False
#     return len(stackdict) == 0
#
...
# # Queue operations
# queue = []
# queue.append("Person 1")  # Enqueue
# queue.append("Person 2")  # Enqueue
